...
internal ref partial struct DataWriter2 : IKBinWriter, IDisposable
{
    ...
    public DataWriter2(Encoding encoding, int capacity = 0)
    {
        _encoding = encoding;
    ...
    public DataWriter2(Encoding encoding, RecyclableMemoryStream stream)
    {
        _encoding = encoding;
        Stream = stream;
        _writeContextManager = new WriteContextManager(Stream);
