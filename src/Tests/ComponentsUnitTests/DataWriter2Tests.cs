...
public class DataWriter2Tests
{
    private readonly ITestOutputHelper _output;

    public DataWriter2Tests(ITestOutputHelper output)
    {
        _output = output;
    }
    ...
    {
        using var writer = new DataWriter2(Encoding.UTF8);
    ...
    public void TestStringWriting_Different_Encodings(string input, string encodingName, string expectedHex)
    {
        ...
        using var writer = new DataWriter2(encoding);
